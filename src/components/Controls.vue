<template>
	...
	<div v-show="show" class="controls">
       <div class="audioplayer">
            <audio id="media" :src="song" style="width: 0px; height: 0px; visibility: hidden;" @timeupdate="handleTimeUpdate">
                 <source :src="song">
            </audio>
...
export default {
  ...
  computed:{
    ...mapState({
      song:state=> "https://music.163.com/song/media/outer/url?id=" + state.song.id + ".mp3",
